...
LArray* LArray_New(ui4 inItemSize) {
    ...
    theObject.mSyncData      = NULL;
        ...
        LDebug_Print("LArray_Constructor [itemsize=%u]\n", inItemSize);
    #endif
...
LArray* LArray_NewFromData(ui4 inItemSize, void** inDataA, ui4 inDataSize) {
    ...
    #ifdef TRACE_OPERATIONS_
        LDebug_Print("LArray_Constructor [itemsize=%u  datasize=%u]\n",
...
ui4 LArray_AppendItem(LArray* This, const void* inItem){
    ...
    #ifdef TRACE_OPERATIONS_
        LDebug_Print("LArray_AppendItem [This->mData size=%u, This->mItemsCount=%u]\n",
...
void LArray_RemoveLastItem(LArray* This) {
    ...
    #ifdef TRACE_OPERATIONS_
        LDebug_Print("LArray_RemoveLastItem [This->mData size=%u, This->mItemsCount=%u]\n",
                      This->mDataSize,This->mItemsCount);
    #endif
}
...
void LArray_RemoveAllItems(LArray* This){
    ...
    #ifdef TRACE_OPERATIONS_
        LDebug_Print("LArray_RemoveAllItems [This->mData size=%u, This->mItemsCount=%u]\n",
                      This->mDataSize,This->mItemsCount);
    #endif
}
...
void LArray_Dump(LArray* This){
    LDebug_Print("LArray: [@%p - mDataSize=%u - mItemsCount=%u - mItemSize=%u]\n",
